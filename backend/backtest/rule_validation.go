...
func GetIndicatorRegistry() []IndicatorDefinition {
	...
	defs := []IndicatorDefinition{
		...
		{IndicatorID: "stock_feature.Volatility20", Name: "Volatility20", Label: "20-day volatility", Source: "feature", Table: "stock_feature", Field: "volatility20", Type: "volatility", Unit: "volatility", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 20},
		{IndicatorID: "stock_feature.Volatility60", Name: "Volatility60", Label: "60-day volatility", Source: "feature", Table: "stock_feature", Field: "volatility60", Type: "volatility", Unit: "volatility", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 60},
		{IndicatorID: "stock_feature.AmihudRatio", Name: "AmihudRatio", Label: "Amihud illiquidity", Source: "feature", Table: "stock_feature", Field: "amihud_ratio", Type: "liquidity", Unit: "ratio", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 5},
		{IndicatorID: "stock_feature.HighLowRatio", Name: "HighLowRatio", Label: "intraday range", Source: "feature", Table: "stock_feature", Field: "high_low_ratio", Type: "volatility", Unit: "ratio", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 1},
		{IndicatorID: "stock_feature.OBV", Name: "OBV", Label: "on-balance volume", Source: "feature", Table: "stock_feature", Field: "obv", Type: "volume", Unit: "volume", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 1},
		{IndicatorID: "stock_feature.RSI14", Name: "RSI14", Label: "RSI14", Source: "feature", Table: "stock_feature", Field: "rsi14", Type: "oscillator", Unit: "oscillator", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 14},
		{IndicatorID: "stock_feature.ChangeRate60", Name: "ChangeRate60", Label: "60-day return", Source: "feature", Table: "stock_feature", Field: "change_rate60", Type: "return", Unit: "return", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 60},
		{IndicatorID: "stock_feature.ChangeRate120", Name: "ChangeRate120", Label: "120-day return", Source: "feature", Table: "stock_feature", Field: "change_rate120", Type: "return", Unit: "return", AllowedOperators: valueOps, AvailableAt: "T_close", LookbackDays: 120},
