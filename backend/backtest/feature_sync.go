...
func (s *FeatureSyncService) toStockFeature(stockCode string, kline data.KLineData, features *KLineFeatures, source string) models.StockFeature {
	...
	return models.StockFeature{
		...
		// Advanced features
		Volatility20:   features.Volatility20,
		Volatility60:   features.Volatility60,
		AmihudRatio:    features.AmihudRatio,
		HighLowRatio:   features.HighLowRatio,
		OBV:            features.OBV,
		RSI14:          features.RSI14,
		ChangeRate60:   features.ChangeRate60,
		ChangeRate120:  features.ChangeRate120,
